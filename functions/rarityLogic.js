...
const RARITY_LEVELS = ["common", "uncommon", "allocated", "rare", "unicorn"];
const CONFIDENCE_LEVELS = ["high", "medium", "low"];
const CLASSIFIER_VERSION = "rarity-v1";
...
- "allocated": deliberately limited by the producer or distributor via store allocations, drawings, lotteries, or scheduled releases.
- "rare": very limited production or release; genuinely hard to get at retail even for someone actively trying.
...
{"rarity": "common" or "uncommon" or "allocated" or "rare" or "unicorn" or null, "confidence": "high" or "medium" or "low", "reason": "one or two short sentences, phrased as a suggestion (\\"Usually...\\", \\"Typically...\\", \\"Availability varies, but...\\"), never an absolute market claim", "normalizedBottleName": "the canonical product name as you recognize it, or empty string"}`;
